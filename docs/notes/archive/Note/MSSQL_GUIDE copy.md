...
2.  เปิด **Terminal** แล้วรันคำสั่งนี้เพื่อดาวน์โหลดและเริ่ม SQL Server:
    ...
    > **สำคัญมาก:**
    >
    > - `Password123!` คือรหัสผ่านของ `sa` (admin สูงสุด) **ต้องตั้งให้ยาก** (มีตัวเล็ก, ตัวใหญ่, ตัวเลข, สัญลักษณ์) ไม่งั้นมันจะไม่รัน
...
ดู logs ว่า SQL Server พร้อมหรือยัง
bash
docker logs azuresqledge --tail 20