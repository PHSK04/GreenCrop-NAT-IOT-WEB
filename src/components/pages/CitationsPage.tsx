...
const citationsData = [
  {
    ...
    pa: 92,
    url: "/article/ai-tools-comparison-2025",
    sentiment: 85,
    visibility: 94,
...
export function CitationsPage() {
  return (
    <>
      {/* Header */}
      <header className="bg-slate-900/50 backdrop-blur-md border-b border-gray-200 px-8 py-6">
      ...
      <main className="flex-1 overflow-auto p-8">
        ...
        {/* Citations Table */}
        <Card className="rounded-xl border-0 shadow-sm bg-slate-900/50 backdrop-blur-md mb-8">
          <CardHeader>
